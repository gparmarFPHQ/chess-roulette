        ...
        <div className="flex items-center space-x-4">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-burgundy-700"
            />
          </div>
            ...
            <div className="space-y-3">
              {filteredHighlights.length === 0 ? (
                ...
                filteredHighlights.map((highlight) => (
                  <div
                    key={highlight.id}
                    className={`p-4 rounded-md border-l-4 ${HIGHLIGHT_COLORS[highlight.color].bg} ${HIGHLIGHT_COLORS[highlight.color].border}`}
                  >
