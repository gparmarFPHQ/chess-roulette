        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="h-10 w-10 rounded-full bg-burgundy-700 flex items-center justify-center text-white font-semibold">
                S
              </div>
            </div>
          </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-12">
          <h3 className="text-lg font-semibold text-slate-900 mb-4 flex items-center">
            <BookOpen className="h-5 w-5 mr-2 text-burgundy-700" />
            Available Cases
          </h3>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            >
              {/* Card Header */}
              <div className="bg-gradient-to-r from-burgundy-700 to-burgundy-900 px-6 py-4">
              ...
              <div className="p-6">
                ...
                {/* Action Button */}
                <button 
                  className="w-full flex items-center justify-center px-4 py-2 bg-burgundy-700 text-white rounded-md hover:bg-burgundy-800 transition-colors font-medium"
                  onClick={(e) => {
                    e.stopPropagation();
                    navigate('/read');
                  }}
            ...
            <div className="bg-slate-50 rounded-lg border-2 border-dashed border-slate-300 p-6 flex flex-col items-center justify-center text-center min-h-[280px]">
