...
// ----------------------------------------------------------------------------
// Case chunks — segmented, visibility-tagged, and attributed to characters.
// ----------------------------------------------------------------------------
...
const chunks: CaseChunk[] = [
  ...
  // ------------------------- V.G. Siddhartha's Background -------------------
  {
    ...
    section: 'V.G. Siddhartha and the Birth of CCD',
...
// ----------------------------------------------------------------------------
// Persona profiles — auto-generated from the case text.
// ----------------------------------------------------------------------------
...
const personaProfiles: PersonaProfile[] = [
  {
    ...
    personality:
      'Visionary, ambitious, and confident. Speaks with the authority of a founder who built a market from scratch. Proud of vertical integration and long-term thinking. Aggressive about growth but thoughtful about brand.',
    goals: [
    ...
    stakeInSituation:
      'Siddhartha founded CCD and has built it into India\'s largest coffee chain. Starbucks\' entry threatens his legacy, valuation, and expansion plans.',
    sampleQuotes: [
    ...
    informationScope:
      'Full access to CCD history, strategy, financials, vertical integration, expansion plans, and personal background. Knows public information about Starbucks but not Tata Starbucks\' internal plans or detailed cost structures.',
  },
  {
    id: 'madhav',
    name: 'Venu Madhav',
    ...
    personality:
      'Strategic, balanced, and pragmatic. Thinks in terms of brand identity and sustainable differentiation. Cautious about mimicking competitors.',
    goals: [
    ...
    stakeInSituation:
      'As a senior director, Madhav is responsible for strategic direction and store format decisions. His credibility depends on making CCD stronger, not just bigger.',
    sampleQuotes: [
    ...
    informationScope:
      'Knows CCD strategy, store formats, multi-format rationale, and general competitive landscape. Does not have access to Starbucks\' internal pricing or Tata\'s real estate plans.',
  },
  {
    id: 'ramakrishnan',
    name: 'Ramakrishnan',
    ...
    company: 'Café Coffee Day',
    personality:
      'Youthful, brand-focused, and protective of CCD\'s mass-market positioning. Believes in emotional connection and localization over premium aspiration.',
    goals: [
    ...
    stakeInSituation:
      'Responsible for brand perception and customer acquisition. Starbucks\' aspirational appeal directly challenges CCD\'s youth positioning.',
    sampleQuotes: [
    ...
    informationScope:
      'Expert in CCD\'s marketing strategy, pricing philosophy, customer segments, and brand campaigns. Limited insight into Starbucks\' internal marketing budgets.',
  },
  {
    id: 'hubli',
    name: 'Jayaraj Hubli',
    ...
    company: 'Café Coffee Day',
    personality:
      'Analytical, disciplined, and cost-conscious. Focuses on unit economics, margins, and capital efficiency. Skeptical of expensive upgrades without clear ROI.',
    goals: [
    ...
    stakeInSituation:
      'CFO accountable for financial performance and investor returns. Any strategic response to Starbucks must be financially defensible.',
    sampleQuotes: [
    ...
    informationScope:
      'Full access to CCD\'s financials, unit economics, cost structure, margins, and capital requirements. Does not know Starbucks\' internal cost structure or Tata\'s investment commitments.',
  },
  {
    id: 'dash',
    name: 'Sushant Dash',
    ...
    personality:
      'Confident, premium-oriented, and deliberate. Believes in global brand power and the India opportunity. Does not apologize for higher prices.',
    goals: [
    ...
    stakeInSituation:
      'Leading marketing for a new joint venture that carries the reputation of both Starbucks and Tata. Success in India is strategically important.',
    sampleQuotes: [
    ...
    informationScope:
      'Knows Starbucks\' global strategy, India market entry approach, target segments, and premium positioning. Public information only about CCD; no access to CCD internal financials.',
  },
  {
    id: 'bijoor',
    name: 'Harish Bijoor',
    ...
    personality:
      'Independent, experienced, and measured. Offers an external industry view. Balances respect for both CCD and Starbucks without bias.',
    goals: [
    ...
    stakeInSituation:
      'An industry commentator and consultant. His credibility depends on balanced, insightful analysis rather than advocacy.',
    sampleQuotes: [
    ...
    informationScope:
      'Broad industry knowledge, public financials, market trends, and strategic observations. No access to confidential internal plans of either company.',
  },
];

// ----------------------------------------------------------------------------
// Character access maps — enforce plausibility at the data layer.
// ----------------------------------------------------------------------------
...
const characters: CharacterAccessMap[] = [
  {
    ...
    personality:
      'Visionary, ambitious, and proud of building CCD from bean to cup.',
    accessibleChunkIds: [
      'ccd-001', 'ccd-002', 'ccd-003', 'ccd-004', 'ccd-005', 'ccd-006', 'ccd-007',
      'ccd-008', 'ccd-009', 'ccd-010', 'ccd-011', 'ccd-012', 'ccd-013', 'ccd-014',
      'ccd-015', 'ccd-016', 'ccd-017', 'ccd-018', 'ccd-019', 'ccd-020', 'ccd-021',
      'ccd-022', 'ccd-023',
    ],
    inaccessibleChunkIds: ['ccd-024', 'ccd-025'],
  },
  {
    characterId: 'madhav',
    ...
    role: 'Director, CCD',
    personality:
      'Strategic, balanced, focused on brand identity and store formats.',
    accessibleChunkIds: [
      'ccd-001', 'ccd-002', 'ccd-006', 'ccd-007', 'ccd-008', 'ccd-009', 'ccd-010',
      'ccd-011', 'ccd-012', 'ccd-013', 'ccd-014', 'ccd-015', 'ccd-016', 'ccd-017',
      'ccd-018', 'ccd-019', 'ccd-020', 'ccd-023',
    ],
    inaccessibleChunkIds: ['ccd-003', 'ccd-004', 'ccd-005', 'ccd-021', 'ccd-022', 'ccd-024', 'ccd-025'],
  },
  {
    ...
    personality:
      'Brand-focused, youth-oriented, protective of affordable positioning.',
    accessibleChunkIds: [
      'ccd-001', 'ccd-002', 'ccd-006', 'ccd-007', 'ccd-009', 'ccd-010', 'ccd-013',
      'ccd-014', 'ccd-015', 'ccd-016', 'ccd-017', 'ccd-018', 'ccd-019', 'ccd-021',
      'ccd-023',
    ],
    inaccessibleChunkIds: ['ccd-003', 'ccd-004', 'ccd-005', 'ccd-008', 'ccd-011', 'ccd-012', 'ccd-020', 'ccd-022', 'ccd-024', 'ccd-025'],
  },
  {
    characterId: 'hubli',
    ...
    personality:
      'Analytical, cost-conscious, disciplined about ROI and margins.',
    accessibleChunkIds: [
      'ccd-001', 'ccd-002', 'ccd-006', 'ccd-007', 'ccd-011', 'ccd-012', 'ccd-013',
      'ccd-014', 'ccd-015', 'ccd-016', 'ccd-017', 'ccd-018', 'ccd-019', 'ccd-022',
      'ccd-023',
    ],
    inaccessibleChunkIds: ['ccd-003', 'ccd-004', 'ccd-005', 'ccd-008', 'ccd-009', 'ccd-010', 'ccd-020', 'ccd-021', 'ccd-024', 'ccd-025'],
  },
  {
    characterId: 'dash',
    ...
    personality:
      'Confident, premium-oriented, focused on brand experience.',
    accessibleChunkIds: [
      'ccd-001', 'ccd-002', 'ccd-006', 'ccd-007', 'ccd-013', 'ccd-014', 'ccd-015',
      'ccd-016', 'ccd-017', 'ccd-018', 'ccd-023',
    ],
    inaccessibleChunkIds: [
      'ccd-003', 'ccd-004', 'ccd-005', 'ccd-008', 'ccd-009', 'ccd-010', 'ccd-011',
      'ccd-012', 'ccd-019', 'ccd-020', 'ccd-021', 'ccd-022', 'ccd-024', 'ccd-025',
    ],
  },
  {
    characterId: 'bijoor',
    ...
    personality:
      'Independent industry expert with balanced, external perspective.',
    accessibleChunkIds: [
      'ccd-001', 'ccd-002', 'ccd-006', 'ccd-007', 'ccd-013', 'ccd-014', 'ccd-015',
      'ccd-016', 'ccd-017', 'ccd-018', 'ccd-019', 'ccd-023',
    ],
    inaccessibleChunkIds: [
      'ccd-003', 'ccd-004', 'ccd-005', 'ccd-008', 'ccd-009', 'ccd-010', 'ccd-011',
      'ccd-012', 'ccd-020', 'ccd-021', 'ccd-022', 'ccd-024', 'ccd-025',
    ],
  },
];

// ----------------------------------------------------------------------------
// Exhibits — tables, charts, photos, and figures from the case.
// ----------------------------------------------------------------------------
...
const exhibits: Exhibit[] = [
  {
    ...
    tableData: {
      columns: ['Year', 'Production (000 tons)', 'Exports (000 tons)', 'Domestic (000 tons)'],
      rows: [
        { Year: 2006, 'Production (000 tons)': 288, 'Exports (000 tons)': 213, 'Domestic (000 tons)': 75 },
        { Year: 2007, 'Production (000 tons)': 294, 'Exports (000 tons)': 219, 'Domestic (000 tons)': 75 },
        { Year: 2008, 'Production (000 tons)': 262, 'Exports (000 tons)': 186, 'Domestic (000 tons)': 76 },
        { Year: 2009, 'Production (000 tons)': 289, 'Exports (000 tons)': 205, 'Domestic (000 tons)': 84 },
        { Year: 2010, 'Production (000 tons)': 302, 'Exports (000 tons)': 215, 'Domestic (000 tons)': 87 },
        { Year: 2011, 'Production (000 tons)': 314, 'Exports (000 tons)': 220, 'Domestic (000 tons)': 94 },
      ],
    },
  ...
  },
  {
    ...
    tableData: {
      columns: ['Chain', 'Approx. Stores', 'Positioning', 'Owner'],
      rows: [
        { Chain: 'Café Coffee Day', 'Approx. Stores': 1400, Positioning: 'Mass-market youth', Owner: 'Amalgamated Bean Coffee' },
        { Chain: 'Barista Lavazza', 'Approx. Stores': 200, Positioning: 'Premium café', Owner: 'Lavazza / private equity' },
        { Chain: 'Costa Coffee', 'Approx. Stores': 80, Positioning: 'Premium international', Owner: 'Costa / JUBILANT' },
        { Chain: 'Starbucks', 'Approx. Stores': 0, Positioning: 'Super-premium', Owner: 'Tata Starbucks JV' },
      ],
    },
  ...
  },
  {
    ...
    chartData: {
      chartType: 'pie',
      labels: ['Europe', 'North America', 'Asia Pacific', 'Latin America', 'Others'],
      series: [{ name: 'Share %', values: [32, 24, 22, 12, 10] }],
    },
  ...
  },
  {
    ...
    tableData: {
      ...
      rows: [
        { Item: 'Initial investment', Value: '₹3-4 million', Notes: 'Interiors, equipment, working capital' },
        { Item: 'Average ticket size', Value: '₹100', Notes: 'Per customer visit' },
        { Item: 'Monthly revenue', Value: '₹350,000-500,000', Notes: 'Varies by location' },
        { Item: 'Food & beverage cost', Value: '30-35% of revenue', Notes: 'Includes coffee, milk, food' },
        { Item: 'Rent', Value: '20-25% of revenue', Notes: 'Higher in prime locations' },
        { Item: 'Labor', Value: '12-15% of revenue', Notes: 'Lower than global chains' },
        { Item: 'EBITDA margin', Value: '12-15%', Notes: 'Target for mature stores' },
        { Item: 'Payback period', Value: '3-4 years', Notes: 'Management estimate' },
      ],
    },
  ...
  },
  {
    ...
    tableData: {
      columns: ['Format', 'Size (sq ft)', 'Seats', 'Typical Locations', 'Menu Focus'],
      rows: [
        { Format: 'Standard Café', 'Size (sq ft)': '1,000-1,500', Seats: '30-40', 'Typical Locations': 'Neighborhoods, colleges', 'Menu Focus': 'Coffee, snacks' },
        { Format: 'CCD Square / Lounge', 'Size (sq ft)': '2,000-3,500', Seats: '60-100', 'Typical Locations': 'Malls, premium areas', 'Menu Focus': 'Premium food & coffee' },
        { Format: 'Kiosk', 'Size (sq ft)': '150-300', Seats: '0-8', 'Typical Locations': 'Airports, offices, transit', 'Menu Focus': 'Grab-and-go beverages' },
      ],
    },
  ...
  },
  {
    ...
    tableData: {
      columns: ['Region', 'Company-Operated', 'Licensed', 'Total'],
      rows: [
        { Region: 'United States', 'Company-Operated': 6383, Licensed: 4680, Total: 11063 },
        { Region: 'Europe / Middle East / Africa', 'Company-Operated': 358, Licensed: 1399, Total: 1757 },
        { Region: 'China / Asia Pacific', 'Company-Operated': 558, Licensed: 1642, Total: 2200 },
        { Region: 'Americas (ex-US)', 'Company-Operated': 778, Licensed: 1673, Total: 2451 },
      ],
    },
  ...
  },
  {
    ...
    tableData: {
      columns: ['Metric', 'FY2009', 'FY2010', 'FY2011'],
      rows: [
        { Metric: 'Revenue ($ billion)', FY2009: 9.77, FY2010: 10.71, FY2011: 11.70 },
        { Metric: 'Operating income ($ billion)', FY2009: 0.56, FY2010: 1.42, FY2011: 1.73 },
        { Metric: 'Net income ($ billion)', FY2009: 0.39, FY2010: 0.95, FY2011: 1.25 },
        { Metric: 'Stores (end of year)', FY2009: 16635, FY2010: 16858, FY2011: 17003 },
      ],
    },
  ...
  },
  {
    ...
    chartData: {
      chartType: 'pie',
      labels: ['Company-Operated Stores', 'Licensed Stores', 'Consumer Products', 'Foodservice & Other'],
      series: [{ name: 'Revenue %', values: [79, 10, 7, 4] }],
    },
  ...
  },
  {
    ...
    tableData: {
      columns: ['Category', 'CCD (est. %)', 'Starbucks Global (%)'],
      rows: [
        { Category: 'Coffee & beverages', 'CCD (est. %)': 60, 'Starbucks Global (%)': 75 },
        { Category: 'Food', 'CCD (est. %)': 25, 'Starbucks Global (%)': 15 },
        { Category: 'Merchandise / Other', 'CCD (est. %)': 15, 'Starbucks Global (%)': 10 },
      ],
    },
  ...
  },
  {
    ...
    tableData: {
      columns: ['Property Type', 'Examples'],
      rows: [
        { 'Property Type': 'Hotels', Examples: 'Taj Mahal Palace, Taj Lands End, Vivanta by Taj' },
        { 'Property Type': 'Retail', Examples: 'Tata Croma, Westside, Zudio' },
        { 'Property Type': 'Real Estate', Examples: 'Premium locations in Delhi, Mumbai, Bangalore, Pune' },
      ],
    },
  ...
  },
  {
    ...
    chartData: {
      ...
      series: [
        { name: 'Male (millions)', values: [200, 125, 110, 90, 70, 45, 30] },
        { name: 'Female (millions)', values: [180, 115, 100, 85, 65, 42, 32] },
      ],
    },
